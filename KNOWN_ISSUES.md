 ...
 **Last updated:** 2026-07-23
 ...
 - **Workaround**: Avoid pausing during relax phase.
 - **Planned resolution**: Fix in next iteration — replace with a simple stable relaxed target (scale: 1, y: 0).
 ...
 - **Status**: Open
 - **Severity**: Medium
 - **Affected area**: All features
 - **Description**: No browser compatibility testing has been recorded. Speech synthesis behavior varies significantly across browsers.
