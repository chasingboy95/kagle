...
const cueTones: Record<SoundCue, readonly ToneStep[]> = {
  ...
  'countdown-5': [{ frequency: 400, duration: 0.1, gain: 0.4 }],
  'countdown-4': [{ frequency: 500, duration: 0.1, gain: 0.45 }],
  'countdown-3': [{ frequency: 600, duration: 0.1, gain: 0.5 }],
  'countdown-2': [{ frequency: 700, duration: 0.1, gain: 0.5 }],
  'countdown-1': [{ frequency: 800, duration: 0.1, gain: 0.55 }],
