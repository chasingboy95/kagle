...
describe('VoiceSettingsPanel', () => {
  ...
  it('renders the panel with correct structure', () => {
    const { container } = render(
      <VoiceSettingsPanel settings={baseSettings} supported onChange={() => {}} onPreview={preview} />,
    );
  ...
  it('toggles enabled state via checkbox', () => {
    ...
    const { container } = render(
      <VoiceSettingsPanel settings={baseSettings} supported onChange={onChange} onPreview={preview} />,
    );
  ...
  it('shows unsupported warning when platform does not support voice', () => {
    render(
      <VoiceSettingsPanel settings={baseSettings} supported={false} onChange={() => {}} onPreview={preview} />,
    );
  ...
  it('plays a sample and lets the user confirm it was audible', async () => {
    ...
    render(
      <VoiceSettingsPanel settings={baseSettings} supported onChange={() => {}} onPreview={onPreview} />,
    );
