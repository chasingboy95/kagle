...
| Mobile UX / Navigation | Partial | The roadmap is documented in `docs/UX_MOBILE_ROADMAP.md` (#88). Records, draft submission, primary navigation, and grouped settings with dedicated reminder/data pages are complete (#89–#92). Final typography, touch-target, motion, and cross-viewport consistency remain tracked by #93. |
