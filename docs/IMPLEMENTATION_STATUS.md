...
| Mobile UX / Navigation | Partial | The roadmap is documented in `docs/UX_MOBILE_ROADMAP.md` (#88). Dedicated records (#89), explicit plan/voice draft submission (#90), and Training/Records/Settings primary navigation with browser-history restoration (#91) are complete. Settings detail regrouping and visual consistency remain tracked by #92–#93. |
