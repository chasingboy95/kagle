...
| Mobile UX / Navigation | Partial | The staged roadmap is implemented through #93: dedicated records/settings pages, explicit draft submission, stable primary navigation, dedicated reminder/data pages, 12px supporting text, 44px core controls, narrow-screen statistics, and shared bottom-sheet behavior. iOS PWA, iOS Safari, and Android Chrome final device acceptance remains outstanding. |
